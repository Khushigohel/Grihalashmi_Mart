...
const Registration = () => {
  ...
  const sendOtp = () => {
    ...
    emailjs
      ...
      .catch(() => handleError("Failed to send OTP"));
  };
        ...
        <div className="card p-4 shadow-sm" style={{ maxWidth: "500px", width: "100%" }}>
          ...
          {!otpSent ? (
            <form onSubmit={handleSignUp}>
              ...
              <div className="mb-3" style={{ position: "relative" }}>
                ...
                <span
                  ...
                  style={{ position: "absolute", top: "70%", right: "10px", cursor: "pointer" }}>
            ...
            <>
              ...
              <button className="btn btn-primary w-100" onClick={handleOtpVerify}>
                Verify & Register
              </button>
            </>
          )}
